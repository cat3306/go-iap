//go:generate mockgen -destination=../mocks/store.go -package=mocks github.com/cat3306/go-iap/appstore/api StoreAPIClient
...
type StoreConfig struct {
	...
	ProxyUrl           string       // The proxy URL for sending requests.
}
