...
//go:generate mockgen  -destination=mocks/playstore.go -package=mocks github.com/cat3306/go-iap/playstore IABProduct,IABSubscription,IABSubscriptionV2,IABMonetization
